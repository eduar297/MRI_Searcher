import os
from Ext.text_processing import query_porcessing
import directory
...
class Evaluator:
    def __init__(self, path_query, path_rel, path_collection):
        ...
        self.irModel = Ext_Vectorial(path_collection)
    ...
    def evaluate_system(self, queries):
        ...
        for query_id in queries:
            ...
            index_of_term = self.irModel.index_of_term
            correlations = self.irModel.correlations
            relevant_documents = self.irModel.process_query(query_porcessing(query,index_of_term,correlations))
...
if __name__ == '__main__':
    ...
    print(es_cran.evaluate_system(
        [1, 2, 4, 8, 9, 10, 12, 13, 15, 18, 22, 23, 26, 27, 29, 31, 32, 33, 34, 35, 39, 40, 41, 49, 50]))

    # es_cisi = Evaluator('cisi\CISI.QRY', 'cisi\CISI.REL', 'collection/cisi/docs')
    # print(es_cisi.evaluate_system(
    #     [1, 2, 4, 8, 9, 10, 12, 13, 15, 18, 22, 23, 26, 27, 29, 31, 32, 33, 34, 35, 39, 40, 41, 49, 50]))